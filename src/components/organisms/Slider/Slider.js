    ...
    <>
      <div>
        ...
        <p>
          ...
          wypełnij krótką ankietę, która pomoże znaleźć odpowiednie rozwiąznie.
        </p>
        <h3>
          Комунікація для біженців війни з України та українців, які проживають
          в Польщі
        </h3>
        <p>
          ...
          вторгнення, Міністерство Юстиції Польщі зазначає, що до диспозицї всіх
          осіб перебуваючих в Польщі, в тим також іноземців, залишається система
          безоплатної допомоги, яка діє відповідно до Закону від 5 серпня 2015
          р. про безоплатну правову допомогу, безоплатні консульації
          громадянські і правової освіти (Вісник законів 2021 року, ст. 945,
          далі: «Закон»). Кожен, хто не може оплатити витрати на оплачувану
          юридичну допомогу, має право на допомогу.
        </p>
        <p>
          ...
          безкоштовної допомоги українською, російською та англійською мовами у
          всіх пунктах допомоги, працює над можливістю збільшення робочого часу
          спеціаліста у сфері прав іноземців у пунктах безоплатної допомоги.
          Детальну інформацію про систему безкоштовної допомоги можна знайти в
          інформаційному буклеті, який містить основні відомості про те, як
          отримати допомогу.
        </p>
      </div>
      <TitleWrapper />
