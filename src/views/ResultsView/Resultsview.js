...
import ResultsWrapper from '../../components/organisms/ResultsWrapper/ResultsWrapper';
import { ContentContext } from '../../providers/ContentProvider';

const ResultsView = () => {
  const { globalCount, globalValue } = useContext(ContentContext);
  ...
  if (output === 10 / 8 || globalCount === 18) {
    ...
    resultObj.image = nm;
    resultObj.title = 'Nieodpłatne Mediacje';
